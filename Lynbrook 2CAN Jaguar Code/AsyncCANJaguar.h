...
// Note that the code in this section is usually placed in a different file; it
// is here solely to make understanding the code more convenient

#define USE_CONVENIENT_DEF
#ifdef USE_CONVENIENT_DEF
/*!
 * Utility functions
 */
class Util {
 ...
 */
class AsyncCANJaguar: public AsyncProcess, public CANJaguar
{
public:
	// collection flags
