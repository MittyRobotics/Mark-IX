...
// TODO: TANAYYYYYYYYYYYYYYYYY get these constants
const int SWITCH_1_PORT = 3;
const int SWITCH_2_PORT = 2;
const int SWITCH_3_PORT = 1;
const int SWITCH_RIGHT_TURRET = 0;			// TODO: Forward
const int SWITCH_LEFT_TURRET = 0;			// TODO: Reverse
const int LOWER_RELAY_PORT = 1;
const int UPPER_RELAY_PORT = 2;

// TODO: TANAYYYYYYYYYYYYYYYYY get these setpoints constants too :D
...
const float TAN_SPINNER_THETA = tan(57.5); 			//TODO: GET THIS ANGLE MORE PRECISELY!
const float SPINNER_DIV = 4250.0;
const float HALF_G = .5 * 9.8 * 100. / 2.54;

//PID constants
//const float SPINNER_kP = 0.125;
//const float SPINNER_kI = 0.004;
//const float SPINNER_kD = 0.0;
const float SPINNER_kP = 10.;
const float SPINNER_kI = 0.004;
const float SPINNER_kD = 0.0;

//Hoop heights
const float SHOOTER_HEIGHT = 41;
const float HOOP_BOT = 23 - SHOOTER_HEIGHT;
const float HOOP_TOP = 93 - SHOOTER_HEIGHT;
const float HOOP_MID = 58 - SHOOTER_HEIGHT;
